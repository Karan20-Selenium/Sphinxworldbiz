...
urlpatterns = [
    ...
    path('<int:id>/', views.ProjectUpdateView.as_view(), name="updatedata"),

    path('delete/<int:id>/', views.ProjectDeleteView.as_view(), name="deletedata"),

    path('', auth_views.LoginView.as_view(template_name='app/login.html',
    ...
    as_view(template_name='app/password_reset.html',form_class=MyPasswordResetForm),
     name='password_reset'),
